      ...
      <div class="columns">
        <div class="column is-4">
          <div class="box ubox">
            ...
            <hr />
            <a class="linkinP" href=""><span> รายละเอียดบัญชี </span></a>
            <hr />
        ...
        <div class="column is-8">
          <div class="k-boxu box">
            <div class="k-title ti1 subtitle">
              <p v-if="!cart.length">ยังไม่มีการสั่งซื้อ</p>
              <a
            ...
            <div v-for="book in cart" :key="book.book_id">
              <div class="media">
                ...
                <div class="media-content pt-2">
                  ...
                  <p class="has-text-grey-light is-6">{{ book.brand }}</p>
                  <div style="display: flex; justify-content: space-between">
                    <div>
                      <!-- ราคาสินค้า------------------------------------------------ -->
                      <span class="is-6 has-text-info">{{ book.price }}</span>
                      <!-- จำนวนสินค้า----------------------------------------------- -->
...
export default {
      ...
      cart: [
        {
          ...
          price: 349,
          image:
            "https://cf.shopee.co.th/file/09e942eb5a057da1a07bb2219f5c866b",
          quantity: 1,
        },
        {
          id: 2,
  ...
  computed: {
    totalPrice() {
      return this.cart.reduce((sum, item) => item.price * item.quantity, 0);
    },
  },
};
</script>
