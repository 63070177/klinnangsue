      ...
      <div class="columns">
          ...
          <div class="box ubox">
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <input class="input" type="translatename" placeholder="สุพิชญา ทำสุนา">
                </p>
            </div>
            <div class="k-fe field">
                <label class="label">เบอร์ติดต่อ</label>
                <p class="control has-icons-left">
                    <input class="input" type="drawname" placeholder="0627384643">
                </p>
            </div>
            <div class="k-fe field">
                <label class="label">เลขที่คำสั่งซื้อ</label>
                <p class="control has-icons-left">
                    <input class="input" type="frontpic" placeholder="37116">
                </p>
            </div>
            <div class="k-fe field">
                <label class="label">ยอดโอน</label>
                <p class="control has-icons-left">
                    <input class="input" type="backpic" placeholder="140฿">
                </p>
            </div>
            <div class="k-fe field">
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <input class="input" type="unit" placeholder="กุมภาพันธ์ 24, 2022">
                </p>
            </div>
          </div>
        </div>
        <div class="column is-4">
          <div class="ubox" style="width: 600px">
            <div class="">
                <div class="box">
            <div class="k-title title">ได้รับการสั่งซื้อเรียบร้อยแล้ว ขอบคุณค่ะ</div>
            <div class="k-fe field">
                <label class="label">เลขที่คำสั่งซื้อ: 37116</label>
            </div>
            <div class="k-fe field">
                <label class="label">วันที่: กุมภาพันธ์ 24, 2022</label>
            </div>
            <div class="k-fe field">
                <label class="label">อีเมล: ruthlasazel@gmail.com</label>
            </div>
            <div class="k-fe field">
                <label class="label">รวมทั้งหมด: 140฿</label>
            </div>
            <div class="k-fe field">
            ...
            <div class="k-fe field">
                <label class="label">ชื่อหนังสือ: 1363 กุหลาบ x1</label>
            </div>
            <div class="k-fe field">
                <label class="label">ราคาหนังสือ: 110฿</label>
            </div>
            <div class="k-fe field">
